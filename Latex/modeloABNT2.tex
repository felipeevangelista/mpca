...
% Introdução
% ----------------------------------------------------------
\chapter[ImplementaÁ„o do SDK utilizado o protocolo SNMP para monitoramento dos serviÁos da Universidade de BrasÌlia]{ImplementaÁ„o do SDK utilizado o protocolo SNMP para monitoramento dos serviÁos da Universidade de BrasÌlia}
